...
ALLOWED_HOSTS = _env_list(
    "ALLOWED_HOSTS",
    default=["*"] if DEBUG else ["localhost", "127.0.0.1", "testserver"],
)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "common.pagination.IMSPageNumberPagination",
    "PAGE_SIZE": 25,
...
# Development-friendly CORS defaults. Tighten with env vars for production.
